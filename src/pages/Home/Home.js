            ...
            <div className={`container ${styles.aboutContainer}`} id='home'>
                <div className='row'>
                    <div className={`col-sm-4 ${styles.aboutColumn}`}>
                        <DisplayPicture style='100%' display='false' picture={profile} />
                    ...
                    <div className={`col-sm-8 ${styles.aboutColumn}`}>
                        <h1>About Me</h1>
                        <p>I started my professional career in the beverage industry, working my way up to production manager at a well known brewery. I loved managing, strategizing and being apart of such a beloved industry. I worked with with a strong drive to increase my skills in management and become a pivotal part of the company's success. But my passion has always been technology. I decided to make a career change and enroll in the University of Texas Coding Boot Camp. I took my work ethic and dedication from striving to be the best manager I could be, and applied it to learn a number of web development methods in just three months.
                        During my time in the boot camp, I gained a strong understanding of many elements in programming such as HTML, CSS, ES6, React NodeJs, and databases such as MongoDB and MySQL. I look forward to taking on any new challenges web development will throw at me to always increase my knowledge and become a great developer. </p>
                    </div>
                </div>
            </div>
            <Skills />
